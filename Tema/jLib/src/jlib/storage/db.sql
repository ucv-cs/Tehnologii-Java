...
components, so that all known facilities from Swing are still available.','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/covers/Java 14 Development of Applications with JavaFX [Klausen, 2018].jpg','23 $','available');
...
Each chapter has example code organized by chapter and section. We’ll try to make a fun project starting with the basic functions of a typical game and we’ll see how the basic game can be expanded upon and we’ll learn a bit about what’s involved with a larger project.','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/covers/Learning CSharp programming with Unity 3D [Okita, 2, 2020].jpg','20 $','borrowed');
INSERT INTO "readers" VALUES (1,'Alin Clincea','Craiova, Romania','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/librarians/alin.clincea.jpg','active');
INSERT INTO "readers" VALUES (2,'James Gosling','Calgary, Canada','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/readers/james.gosling.jpg','active');
INSERT INTO "readers" VALUES (3,'Miruna Dumitriu','Filiași, Dolj','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/readers/miruna.dumitriu.jpg','inactive');
INSERT INTO "readers" VALUES (4,'Elena Popa','Cârcea, Dolj','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/readers/elena.popa.jpg','active');
INSERT INTO "readers" VALUES (5,'Cătălin Ionescu','Craiova, Dolj','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/readers/catalin.ionescu.jpg','banned');
INSERT INTO "readers" VALUES (6,'Angela Ștefan','Târgu Jiu, Gorj','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/readers/angela.stefan.jpg','active');
INSERT INTO "librarians" VALUES (1,'admin','pass','Alin Clincea','Craiova','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/librarians/alin.clincea.jpg','administrator');
INSERT INTO "librarians" VALUES (2,'alex','123','Alexandru Georgescu','București','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/librarians/alexandru.georgescu.jpg','librarian');
INSERT INTO "librarians" VALUES (3,'ionela','qwerty','Ionela Marin','Slatina, Olt','D:/Documents/Facultate/Teme/Tehnologii Java/Tema/jLib/src/storage/librarians/ionela.marin.jpg','librarian');
COMMIT;
